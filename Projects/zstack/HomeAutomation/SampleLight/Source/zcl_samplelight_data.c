...
#define ATMEEX_COMMAND 0x01
#define ATMEEX_CLUSTER_ID 0x0006
/*********************************************************************
 * TYPEDEFS
 */
...
#define ZCLSAMPLESW_MAX_OUTCLUSTERS   ( sizeof( zclSampleLight_OutClusterList ) / sizeof( zclSampleLight_OutClusterList[0] ))
