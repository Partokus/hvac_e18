...
#define SEND_MESSAGE_BY_ON_OFF_BUTTON_EVT              0x80
#define SEND_MESSAGE_BY_DAMPER_BUTTON_EVT              0x100
#define SEND_MESSAGE_BY_PID_BUTTON_EVT                 0x200
#define SEND_MESSAGE_BY_MODE_BUTTON_EVT                0x400
#define SEND_MESSAGE_BY_COND_AND_BREEZER_BUTTONS_EVT   0x800
#define SEND_MESSAGE_BY_HUMIDIFIER_BUTTONS_EVT         0x1000
#define SEND_MESSAGE_BY_TEMP_BUTTONS_EVT               0x2000
#define STOP_OTA_FOR_AVR_TIMER                         0x4000
...
#define SEND_GET_REQUEST_DELAY                   10000
